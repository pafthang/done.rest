...
type AuthManageClients struct {
	...
	//mngSub transport.ISubscription
}
...
func (svc *AuthManageClients) AddDevice(
	ctx clidone.ServiceContext, args authapi.AddDeviceArgs) (authapi.AddDeviceResp, error) {
...
func (svc *AuthManageClients) AddService(
	ctx clidone.ServiceContext, args authapi.AddServiceArgs) (authapi.AddServiceResp, error) {
	...
	if args.PubKey != "" {
		...
		resp.Token, _ = svc.msgServer.CreateToken(authInfo)
	}
	err = svc.onChange()
	return resp, err
}
...
func (svc *AuthManageClients) AddUser(
	ctx clidone.ServiceContext, args authapi.AddUserArgs) (authapi.AddUserResp, error) {
	slog.Info("AddUser",
		slog.String("senderID", ctx.SenderID),
...
func (svc *AuthManageClients) GetAuthClientList() []modbus.ClientAuthInfo {
...
func (svc *AuthManageClients) GetClientProfile(ctx clidone.ServiceContext,
...
func (svc *AuthManageClients) RemoveClient(ctx clidone.ServiceContext, args authapi.RemoveClientArgs) error {
...
func (svc *AuthManageClients) SetClientPassword(ctx clidone.ServiceContext, args authapi.SetClientPasswordArgs) error {
...
func (svc *AuthManageClients) UpdateClient(ctx clidone.ServiceContext, args authapi.UpdateClientArgs) error {
	slog.Info("UpdateClient", "clientID", args.ClientID, "role", args.Profile.Role)
	err := svc.store.Update(args.ClientID, args.Profile)
	return err
}

func (svc *AuthManageClients) UpdateClientRole(ctx clidone.ServiceContext, args authapi.UpdateClientRoleArgs) error {
