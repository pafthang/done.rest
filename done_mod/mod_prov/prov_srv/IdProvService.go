...
// and require the device to refresh with the auth service directly, after connecting to the clidone.
//
...
func (svc *IdProvService) Start(hc *clidone.HubClient) (err error) {
	...
	err = myProfile.SetServicePermissions(provapi.ManageProvisioningCap, []string{
