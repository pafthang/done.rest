...
func (svc *LauncherService) _startPlugin(pluginName string) (pi runapi.PluginInfo, err error) {
...
// This creates a plugin authentication key and token files in the credentials directory (certs)
// before starting the plugin.
func (svc *LauncherService) StartPlugin(ctx clidone.ServiceContext,
	args runapi.StartPluginArgs) (runapi.StartPluginResp, error) {
	...
	resp := runapi.StartPluginResp{PluginInfo: pluginInfo}
	return resp, err
}
...
func (svc *LauncherService) StopAllPlugins(ctx clidone.ServiceContext,
	args *runapi.StopAllPluginsArgs) (err error) {
...
func (svc *LauncherService) StopPlugin(
	ctx clidone.ServiceContext, args runapi.StopPluginArgs) (resp runapi.StopPluginResp, err error) {
...
func (svc *LauncherService) updateStatus(svcInfo *runapi.PluginInfo) {
	if svcInfo.PID != 0 {
